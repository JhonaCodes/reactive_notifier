  ...
  group('ReactiveNotifier Listener Notifications', () {
    ...
    group('Basic Listener Notification Tests', () {
      ...
      test('should notify listener immediately when state changes', () {
        ...
        expect(notificationTime!.difference(updateTime).inMilliseconds, lessThan(10),
      ...
      test('should notify listener for different data types', () {
        ...
        expect(receivedList, ['a', 'b', 'c'], reason: 'List listener should work');
    ...
    group('Multiple Listener Management Tests', () {
      test('should notify all registered listeners when state updates', () {
        ...
        expect(listener1Value, equals(10), reason: 'First listener should receive value');
        expect(listener2Value, equals(10), reason: 'Second listener should receive value');
        expect(listener3Value, equals(10), reason: 'Third listener should receive value');
        expect(listener1Calls, equals(1), reason: 'First listener should be called once');
        expect(listener2Calls, equals(1), reason: 'Second listener should be called once');
        expect(listener3Calls, equals(1), reason: 'Third listener should be called once');
      });
      ...
      test('should notify listeners in the order they were added', () {
        ...
        expect(executionOrder, equals(['listener1', 'listener2', 'listener3']),
            reason: 'Listeners should execute in the order they were registered');
      });

      test('should handle listeners that access the notifier value during callback', () {
        ...
        expect(totalSum, equals(60), 
            reason: 'Sum should be calculated correctly by second listener (10+20+30)');
      });
      ...
      test('should handle large number of listeners efficiently', () {
        ...
        for (int i = 0; i < listenerCount; i++) {
          notify.addListener(() {
            totalCallbacks++;
            if (i % 100 == 0) { // Sample every 100th listener
    ...
    group('Listener Removal and Cleanup Tests', () {
      test('should not notify removed listeners', () {
        ...
        notify.updateState(5);
        expect(listenerValue, equals(5), reason: 'Listener should work initially');
        expect(callCount, equals(1), reason: 'Listener should be called initially');
      ...
      test('should handle removal of non-existent listeners gracefully', () {
        ...
        expect(() => notify.removeListener(nonExistentListener), returnsNormally,
        ...
        expect(receivedValue, equals('works'), 
            reason: 'Notifier should work normally after attempted removal of non-existent listener');
      });
      ...
      test('should handle removal of listeners during notification', () {
        ...
        expect(listener2Calls, equals(1), 
            reason: 'Listener removed by other should still be called in same cycle');
      ...
      test('should properly clean up all listeners with multiple removals', () {
        ...
        expect(totalCalls, equals(10), reason: 'All listeners should be called initially');
    ...
    group('Notification Edge Cases and Error Handling', () {
      test('should handle listeners that throw exceptions by continuing normal operation', () {
        ...
        expect(normalListener2Calls, equals(1), 
            reason: 'Second listener should be called despite exception from previous listener');
        
        // Assert: State should still be updated correctly
        expect(notify.notifier, equals(5), 
            reason: 'State should be updated correctly despite listener exception');
      });
      ...
      test('should maintain correct state during nested notifications', () {
        ...
        notifierA.addListener(() {
          aCallCount++;
          if (aCallCount == 1) { // Only update B once to prevent loops
        ...
        expect(bCallCount, equals(1), 
            reason: 'NotifierB listener should be called once due to nested update');
