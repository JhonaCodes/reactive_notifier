...
void main() {
  group('AsyncViewModelImpl<T> Tests', () {
    ...
    group('AsyncViewModel Lifecycle Tests', () {
      ...
      test(
        'should handle onResume callback after successful initialization',
        () async {
    ...
    group('AsyncViewModel State Update Tests', () {
      test(
        'should update state and notify listeners with updateState()',
        () async {
    ...
    group('AsyncViewModel State Transformation Tests', () {
      ...
      test('should transform data with transformDataState()', () async {
        ...
        final viewModel = ListAsyncViewModel(
          initialData: [1, 2, 3],
          loadOnInit: false,
        );
      ...
      test(
        'should transform data silently with transformDataStateSilently()',
        () async {
          // Setup: Create AsyncViewModel with List data
          final viewModel = ListAsyncViewModel(
            initialData: [10, 20],
          ...
          viewModel.transformDataStateSilently(
            (currentData) =>
      ...
      test(
        'should handle null return in transformDataState gracefully',
        () async {
    ...
    group('AsyncViewModel Cross-Communication Tests', () {
      test('should setup reactive communication with listenVM()', () async {
        ...
        final sourceViewModel = TestAsyncViewModel(
          initialData: 'source_data',
          loadOnInit: false,
        );
        ...
        final currentState = await dependentViewModel.listenToSource(
          sourceViewModel,
        );
        ...
        expect(
          dependentViewModel.receivedSourceState?.isSuccess,
          isTrue,
          reason:
        ...
        expect(
          dependentViewModel.receivedSourceState?.data,
      ...
      test(
        'should stop reactive communication with stopListeningVM()',
        () async {
          // Setup: Create source and dependent AsyncViewModels
          final sourceViewModel = TestAsyncViewModel(
            initialData: 'source',
