  ...
  group('ViewModelContextProvider Tests', () {
    ...
    testWidgets(
      ...
      (tester) async {
              ...
              build: (state, viewmodel, keep) {
                return Column(
                  children: [
                    ...
                    Text(
                      'Widget: ${viewmodel.capturedContextWidget ?? 'none'}',
                    ),
                  ],
                );
              },
        ...
        expect(
          viewModel.capturedContextWidget,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          asyncViewModel.capturedContextWidget,
        ...
        // Verify UI shows correct information
        expect(
          find.text('State: async initialized with context'),
          findsOneWidget,
        );
        expect(find.text('Had context: true'), findsOneWidget);
      },
    ...
    testWidgets('requireContext should throw when context is not available', (
      ...
      expect(
        () => viewModel.requireContext('test operation'),
    ...
    testWidgets('requireContext should return context when available', (
      ...
      expect(
        capturedContext?.widget.runtimeType.toString(),
        contains('ReactiveViewModelBuilder'),
      );
    });
    ...
    testWidgets('context should be cleared when all builders are disposed', (
      ...
      await tester.pumpWidget(
        const MaterialApp(home: Text('Different screen')),
      );
