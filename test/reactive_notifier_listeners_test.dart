  ...
  group('ReactiveNotifier Listeners', () {
    ...
    group('listen() Method Tests', () {
      ...
      test('should handle custom object values correctly in listener callback', () {
        ...
        final notifier = ReactiveNotifier<TestModel>(() => TestModel(id: 1, name: 'initial'));
        var callbackCallCount = 0;
      ...
      test('should replace previous listener when listen() is called multiple times', () {
      ...
      test('should work correctly with transform methods', () {
        ...
        notifier.transformStateSilently((v) => v + 5);   // 10 -> 15 (should NOT trigger)
    ...
    group('listen() Integration Tests', () {
      test('should work correctly with cross-notifier communication', () {
        ...
        expect(receivedTransformations, equals(['transformed_20', 'transformed_30']));
